...
### Administração de dados de pacientes:
  Listar, adicionar, alterar ou excluir pacientes. Registrar sua **matrícula, nome, sobrenome e RG**. Solicita-se o desenvolvimento de um **CRUD** para a entidade **Paciente**.
  #### Métodos
